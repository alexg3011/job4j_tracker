...
public class BankService {
     ...
     *                      В случае не нахождения в базе одного из вышеперечисленных
     *                      параметров метод возвращает false
     ...
     *                      затем ищем аккаунт, куда надо перевести по паспорту и реквизитам
